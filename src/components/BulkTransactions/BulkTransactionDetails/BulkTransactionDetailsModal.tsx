// BulkTransactionDetailsModal.tsx
import React from "react";
import { X, ReceiptText, IndianRupee } from "lucide-react";
import { formatDate } from "../../ProfitLoss/utils";

interface BulkTransactionDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  transaction: any; // Replace with proper typing if you have
}

const BulkTransactionDetailsModal: React.FC<BulkTransactionDetailsModalProps> = ({
  isOpen,
  onClose,
  transaction,
}) => {
  ...
  console.log('TRANSACTIONAL', transaction)
  return (
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-base font-medium">{transaction.accountName || "N/A"}</p>
            </div>
...
export default BulkTransactionDetailsModal;
