...
interface BulkTransactionsPaginationProps {
  currentPage: number;
  totalPages: number;
  totalResults: number;
  limit: number;
...
const BulkTransactionsPagination: React.FC<BulkTransactionsPaginationProps> = ({
  currentPage,
  totalPages,
  totalResults,
  limit,
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <p className="text-sm text-gray-600">
            ...
            <span className="font-semibold text-gray-900">{totalResults}</span> transactions
          </p>
...
export default BulkTransactionsPagination;