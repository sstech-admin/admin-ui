import { TrendingUp, DollarSign, PiggyBank, Wallet, Target } from 'lucide-react';
...
function InvestmentDataCard({ invested6040, profit5050, profit6040, totalInvested, returnPercentage }: InvestmentDataProps) {
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 flex items-center justify-between">
          ...
          <p className="text-xl font-semibold text-gray-800">{formatCurrency(totalInvested)}</p>
        </div>
