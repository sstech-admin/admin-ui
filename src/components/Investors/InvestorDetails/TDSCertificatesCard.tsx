...
import TDSCertificateUploadModal from './TDSCertificateUploadModal';
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-100">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button 
              ...
              className="flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all shadow-sm"
            >
              <Upload size={16} />
        ...
        {!loading && !error && certificates.length === 0 && (
          <div className="py-12 text-center">
            ...
            <button 
              onClick={() => setIsUploadModalOpen(true)}
              className="mt-4 px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg hover:from-blue-600 hover:to-indigo-600 transition-all shadow-sm"
            >
              Upload Certificate
            </button>
          </div>
