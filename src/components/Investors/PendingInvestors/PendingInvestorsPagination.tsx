...
interface PendingInvestorsPaginationProps {
  currentPage: number;
  totalPages: number;
  totalResults: number;
  limit: number;
...
const PendingInvestorsPagination: React.FC<PendingInvestorsPaginationProps> = ({
  currentPage,
  totalPages,
  totalResults,
  limit,
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <p className="text-sm text-gray-600">
            ...
            <span className="font-semibold text-gray-900">{totalResults}</span> pending investors
          </p>
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              disabled={loading}
              className="text-sm border border-gray-300 rounded-lg px-3 py-1 focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white"
            >
...
export default PendingInvestorsPagination;