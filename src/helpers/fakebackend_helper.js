...
export const deleteAPIKey = (apikey) =>
  api.delete(url.DELETE_API_KEY, { headers: { apikey } });
...
export const deleteToDo = (id) =>
  api.delete(url.DELETE_TODO, { headers: { id } });
