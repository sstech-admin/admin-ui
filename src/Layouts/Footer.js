  ...
  return (
    <StyleFooter id="antFooterLayout">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', whiteSpace:'nowrap', zIndex:'9' }}>
                    <p style={{marginRight:'16px', marginBottom:'0'}}>{new Date().getFullYear()} © Dharma InfoSystem.</p>
                    {/* <p style={{marginBottom:'0'}}> Design & Develop by <Link to='https://www.dharmainfosystem.in/' target='_blank'>Dharma InfoSystem</Link></p> */}
                </div>
      </Row>
    </StyleFooter>
  );
